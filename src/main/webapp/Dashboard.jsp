...
<html>
    ...
    <body>
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="container">
                ...
                <div class="row grid-margin mt-5">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="statistics-item text-center shadow-animate total">
                            <p><i class="fas fa-envelope-open icon total-icon"></i>  Production TOTAL</p>
                            <h2 id="counter-total-pro" class="circle-value counter" data-target="0">0</h2>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-12">
                        <div class="statistics-item text-center shadow-animate total">
                            <p><i class="fas fa-paper-plane icon success-icon"></i>  Production SUCCESS</p>
        ...
        <script type="text/javascript">
            ...
            // Current day data chart (example with today's data)
//            function drawCurrentDayData() {
...
//                        subtitle: 'Sales, Expenses, and Profit by Month',
//                    },
//                    bars: 'vertical',
...
//            }
            ...
            // Previous day data chart (example with yesterday's data)
//            function drawPreviousDayData() {
//                var data = google.visualization.arrayToDataTable([
//                    ['Month', 'Sales', 'Expenses', 'Profit'],
//                    ['Jan', 1200, 800, 400],
//                    ['Feb', 1500, 900, 600],
...
//                };
//
//                var chart = new google.charts.Bar(document.getElementById('previousDay'));
//                chart.draw(data, google.charts.Bar.convertOptions(options));
//            }
        </script>
...
//                        failed += item.Failed || 0;
                ...
                // AJAX request to fetch data
                $.ajax({
                    url: 'NhaServletProduction', // Adjust the URL as needed
                    type: 'GET',
                    dataType: 'json',
                    beforeSend: function () {
                        loaderOverlay.style.display = 'flex';  // Show loader before request
