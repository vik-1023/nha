...
<html>
    ...
    <%
        ...
        java.text.SimpleDateFormat sdfForInput = new java.text.SimpleDateFormat("yyyy-MM");
        java.text.SimpleDateFormat sdfForDisplay = new java.text.SimpleDateFormat("MMM yyyy");

        java.util.Date currentDateObj = new java.util.Date();
        String currentMonthYearValue = sdfForInput.format(currentDateObj); // For form submission (YYYY-MM)
        String currentMonthYearDisplay = sdfForDisplay.format(currentDateObj); // For display (MMM YYYY)
    %>
    <body
        <!-- ======= Header ======= -->
